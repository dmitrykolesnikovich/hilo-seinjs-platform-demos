...
class MainScript extends Sein.LevelScriptActor {
  public onPreload() {
    this.getGame().resource.load({type: 'Atlas', name: 'particles.atlas', url: require('../../assets/sprites/particles.atlas')});
    this.getGame().resource.load({type: 'Image', name: 'firework-shape.png', url: require('../../assets/sprites/firework-shape.png')});
    this.getGame().resource.load({type: 'Image', name: 'firework-mask.png', url: require('../../assets/sprites/firework-mask.png')});
  }
  ...
  public onCreate() {
    ...
    world.addActor('particleSystem1', Sein.GPUParticleSystem.Actor, {
      ...
      maxVelocity: 1.5,
      minVelocity: .8,
      atlas: game.resource.get<'Atlas'>('particles.atlas'),
